...
# output "cmdkey" {
#   value     = "cmdkey /add:TERMSRV/\"${aws_eip.eip.public_ip}\" /user:\"AW_2025_02\\admin\" /pass:\"${rsadecrypt(aws_instance.dev.password_data, tls_private_key.private-key.private_key_pem)}\""
#   sensitive = true
# }
